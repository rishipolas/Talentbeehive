  ...
  <div class="content-wrapper">
   ...
   <?php
    ...
    <?php  echo $getstatedetails['statename'];?> , <?php  echo $getcitydetails['cityname']; ?></td>
                                  ...
                                  <td width="52%" align="left" valign="top" style="line-height:30px"><a class="btn btn-default" onclick="return confirm('Do You Really want to Request For video ');"  href="institute_request_video.php?video_status=send&email=<?php echo $row['email'];?>&fname=<?php echo  $fname; ?>&ids=<?php echo $ids; ?>&cid=<?php echo  $cid; ?>">Request Video Profile/PPT</a>
