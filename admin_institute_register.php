   ...
   $video=$_FILES['video']['name']; 
		...
		if($exti[$ci-1] != "jpeg" && $exti[$ci-1] != "jpg" && $exti[$ci-1] != "png")
	{
		echo ("<SCRIPT LANGUAGE='JavaScript'>	
			        window.alert('image Format  Not Suported ')   </SCRIPT>");	
              ...
              // if(move_uploaded_file($_FILES["video"]["tmp_name"] , "institutevideo/".$vname))
		//{			
					if(move_uploaded_file($_FILES["clogo"]["tmp_name"] , "institute/institutelogo/".$imagename))
			     {
				
				
			$insert = "INSERT into institute_registration (institute_name,contact_person,email,website_url,state,city,mobile,landline,password,confirm_password,video,institute_logo,qualification,course,date_time) VALUES('$name','$cpname','$email','$website',$state,$city,'$number','$lnumber','$password','$cpassword','$vname','$imagename','$qualification1','$course1','$dt')";
		...
		if ($DB->query($insert) === TRUE) {
       			 ...
       			 echo ("<SCRIPT LANGUAGE='JavaScript'>
	                        window.alert('Institute inserted Successfully!! ')
	                       window.location.href('admin_institute_display.php')
	                        </SCRIPT>");
       ...
       else
       {
        echo ("<SCRIPT LANGUAGE='JavaScript'>
	                        window.alert('Fail')
	                        window.location.href('admin_institute_register.php');
	                        </SCRIPT>");
 ...
 ?>
  <div class="content-wrapper">
    ...
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Institute Insert</div>
      <div class="card-body">
        <form method="POST"  enctype="multipart/form-data" >
		 <div class="form-group">
            <label for="exampleInputName">Institute Name</label>
            
            <input class="form-control" id="exampleInputName" pattern="[a-z,A-Z]{3,50}"  aria-describedby="emailHelp" name="name">
          </div>
          
           <div class="row">
          <div class="form-group col-sm-6 field-wrap">         
            <label for="exampleInputName">Contact Person Name</label>
           
            <input class="form-control" id="exampleInputName" pattern="[a-z,A-Z]{3,50}"  aria-describedby="emailHelp" name="cpname">
            </div>
            
             <div class="form-group col-sm-6 field-wrap"> 
            <label for="exampleInputEmail1">Email address</label> 
            
            <input class="form-control" id="exampleInputEmail1"pattern="[a-zA-Z0-9]+\.?[a-zA-Z0-9]+@[A-Za-z0-9.-]+\.[a-z]{2,3}"  aria-describedby="emailHelp" name="email">
          </div>                 
          </div>
         ...
         <div class="row">
          <div class="form-group col-sm-6 field-wrap">         
            ...
            <input class="form-control" id="exampleInputCWeb"  type="text" name="cweb">
            </div>                               
          </div>
                  ...
                  <div class="form-group asdf">
                     <div class="form-row">
                        <div class="col-md-12">
                           ...
                           &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<select class="form-control course_select_parent " name="course[]" id="course" multiple="multiple" value="<?php echo $row2['course'];?>" >  
                           </select>
...
<select  class="form-control" id="city" name="city" placeholder="city">
	...
	$number=$rec['mobile'];
	list($mnumber, $num) = explode("-", $number);
	
	$lnumber=$rec['landline'];
	list($code, $lnum) = explode("-", $lnumber);
	?>
	<div class="form-group">
            <div class="form-row">
	     ...
	     <label for="exampleInputName">Contact Number</label>
	       <div class="form-row">
	         <div class="col-md-3">	
			<input class="form-control" id="exampleInputName" type="text" name="mnumber"   value="+91" readonly>
		 </div>	
		 <div class="col-md-9">	
						<input class="form-control" id="exampleInputName" type="text" name="num"  pattern="[6-9]{1}[0-9]{9}" title="should contain exact 10 digit, start with range between 6-9." placeholder="Mobile Number" >
		 </div>	
		</div>		
              </div>	
              	
           <div class="col-md-6">	 
	     <label for="exampleInputName">landline Number</label>
	       <div class="form-row">
				<div class="col-md-4">
				...
				<input class="form-control" id="exampleInputCWeb" type="text" pattern="[0-9]{5,8}" placeholder="Enter Landline Number" name="lnum" >
		...
		<div class="col-md-6 form-group">
						...
						<input class="form-control" name="password" id="password"  type="password" placeholder="Password" required="" onKeyUp="validate1()">
						 <span style="color:red;" id="mylocation1"></span>
						 <script>
							function validate1() {  
						...
						<input  class="form-control" name="cpassword" id="cpassword" type="password" placeholder="Confirm Password" required="" onKeyUp="validate1(); validate();">
						<span style="color:red;" id="mylocation"></span> 
						 <script>
						 function validate() {  
							var pass=document.myForm.password.value;
		...
		<div class="col-lg-6 form-group">
                          <label>Presentation - Video / PPT / PDF<span class="req">*</span></label>
                          <input type="file" class="form-control-file" name="video" id="video"  placeholder="video">
                      </div>
					<div class="col-md-6 form-group">
						
						 <label class="lregister pull-left">Institute Logo<span class="req">*</span></label>
