  ...
  <div class="content-wrapper">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <label for="exampleInputJT">Job Title<span class="req"> *</span></label>
         ...
         <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <label for="exampleInputFR">Functional Role<span class="req"> *</span></label>
     ...
     <a class="btn btn-primary" id="show1" onclick="myFunction1()">Next</a> 
      ...
      <div class="form-group">
          ...
          <div class="form-group">
             ...
             <label for="exampleInputAT">Application Type<span class="req"> *</span></label> 
...
<p id="to">To &nbsp; &nbsp;</p>
          ...
          <!--<input type="text" class="form-control" name='year' id='year' placeholder="eg. 0 to 1 Yrs">-->
           ...
           <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
               <label for="exampleInputLocation">Country<span class="req"> *</span></label>
          <!--<input type="text" class="form-control" name='country' id='country' placeholder="India">-->
                         <select class="form-control" name='country' id='ex-drop123' required>
    ...
    ?>  
       ...
       <div class="form-group">
            <div class="form-row Ind">
              <div class="col-md-6">
                <label for="exampleInputLocation">State<span class="req"> *</span></label>
...
<div class=" col-md-6 field-wrap Ind2">
            <label for="exampleInputAT">city<span class="req"> *</span></label>
...
<div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <label for="exampleInputJT">Walkin Start<span class="req"> *</span></label>
                <input class="form-control" id="datepicker" type="text"  placeholder="walkin Start" name="walkinst" title="required" required >
              </div>
             
             <div class="col-md-6">
                <label for="exampleInputcomapnyname">Walkin End<span class="req"> *</span></label>
               <input class="form-control" id="datepicker1" type="text"  placeholder="walkin Start" name="walkinend" title="required" required >
              </div>
           ...
           <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <label for="exampleInputJT">Time From</label>
        
                <input class="form-control" id="timepicker" type="text"  placeholder="walkin Start" name="tist" title="required" required>
              </div>
             
             <div class="col-md-6">
                <label for="exampleInputcomapnyname">Time To End</label>
               <input class="form-control  " id="timepicker1"  type="text" placeholder="walkin Start" name="tiend" title="required" required>
              </div>
...
<div class="form-group">
            <label for="exampleInputJD">Venue For Interview </label>
            <textarea class="form-control" id="description" placeholder="Enter place or Location for Interview " name="venue" rows="4" cols="80"></textarea>
          </div>
...
var timepicker = $("#timepicker1").data("kendoTimePicker");
...
$state=$_POST['state'];
$city=$_POST['city'];
$walkinst=$_POST['walkinst'];
$walkinend=$_POST['walkinend'];
$walk1=$walkinst."==".$walkinst;
...
$dt=date("d-m-y")."/".date("h:i:sa");
  ...
  $query   = "INSERT INTO walkindata(type,title,name,email,role,openings,qualification,course,specialization,skills,atype,year,country,state,city,walk1,time1,venue,description,date)    values('$type','$title','$name','$email','$role','$openings','$qualification1','$course1','$specialization1','$skills','$atype','$year','$country',$state,$city,'$walk1','$time1','$venue','$description','$dt')";
...
$( document ).ready(function() {
    swal({
     ...
     document.location.href='walkinpost_view.php'
});
});
        ...
        {                                                 echo ("<SCRIPT>
                ...
                window.location.href='walkinpost.php';
                </SCRIPT>");
