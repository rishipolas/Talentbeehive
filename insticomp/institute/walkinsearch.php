...
<section id="hero">
 ...
 $city=$_POST['city'];
  ...
  $q="select * ,walkindata.id as fid from walkindata where city='".$city."'";
  $result=mysqli_query($DB,$q);
		...
		?>			  
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
            ...
            <div class="box" id="carddata">
            
              <div class="icon"><a href="stud_walkin_23.php?id=<?php echo  $row['fid'];?>"><strong>View</strong></a></div>
              <h4 class="title"><?php echo $row['title'];?></h4>
              <span class="description"><i class="fa fa-building" aria-hidden="true"></i> <strong style="color:#ffcd01"><?php echo $row['cname'];?></strong></span>
                <p class="description index-show-read-more">Skills: <?php echo $row['skills'];?></p>
                <?php
		...
		?>
               <div> City:<strong style="color:#ffcd01"><?php echo $getcitydetails['cityname'];?></strong></div>
