...
try {
  ...
  $mail->isHTML(true);                                  // Set email format to HTML
	$mail->Subject   = 'Invitation alert from ' . $_SESSION['name'] . ' ';
...
<div style="margin:40px;">
              ...
              <p>' . $_SESSION['name'] . ' has invited your estimed orgnization to go through<br>
		the profiles of students & provide them an opportunity to step<br>
		into career.Click below to view institute profile. <br><p>
              <br>
              
              <a class="btn btn-primary btn-block"" href="https://www.talentbeehive.com/insticomp/institute_prof_view.php?iid='.$instiid.'&fname='.$fname.'&inid='.$inid.'&cid='.$cid.'">View Institute Profile</a><br><br>
