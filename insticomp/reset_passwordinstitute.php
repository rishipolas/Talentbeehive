<?php
	if(isset($_POST["reset-password"])) {
		...
		$sql = "UPDATE institute_registration SET password = '" .$_POST["password"]. "' ,confirm_password = '" .$_POST["confirm_password"]. "' where email='".$_POST['email']."'";
								...
								<?php } ?>
                                    ...
                                    <div class="field-wrap">
                                     ...
                                     <div class="field-wrap">
									  ...
									  <div class="field-wrap">
                                       <input type="password"  class="clr-place" name="confirm_password" id="confirm_password" placeholder="*Confirm New Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                                    </div>
