...
$numr=mysqli_num_rows($resultr);
			   ...
			   ?>
			   	...
			   	<?php
$qr1="select *,walkindata.id as fid from walkindata INNER JOIN users ON walkindata.name=users.cname  where walkindata.status='active' ORDER BY walkindata.id DESC";

$resultr1=mysqli_query($con,$qr1);
$numr1=mysqli_num_rows($resultr1);
?>

           <a class="postedJobsCount" href="#services"><span class="count"><?php echo $numr; ?></span> Jobs</a>
            <a class="postedJobsCount" href=""><span class="count"><?php echo $numr1; ?></span> Walkins</a>
              </div>
    </div>
	...
	?>
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
            <div class="box">
              ...
              <h4 class="title"><a href="stud_walkin_23.php?id=<?php echo  $rowr['fid'];?>"><?php echo $rowr['title'];?></a></h4>
...
?>		
    ...
    <section id="services">
      <div class="container wow fadeIn">
        <div class="section-header">
		  <h2 class="section-title"><span> (<?php echo $numr1; ?>) </span> This Weeks Walkin </h2>
	...
	?>
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
            <div class="box">
              ...
              <div class="icon"><a href="stud_walkin_23.php?id=<?php echo  $rowr1['fid'];?>"><strong>view</strong></a></div>
              <h4 class="title"><?php echo $rowr1['title'];?></h4>
              <span class="description"><i class="fa fa-building" aria-hidden="true"></i> <strong style="color:#ffcd01"><?php echo $rowr1['cname'];?></strong></span>
		
	  	 <p class="description index-show-read-more">Skills: <?php echo $rowr1['skills'];?></p>
...
?>		
       ...
       <a class="btn btn-default center-block btn-lg" href="show_more_walkin.php">View More</a>
    </section><!-- #services -->
