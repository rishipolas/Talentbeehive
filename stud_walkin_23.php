...
$q="select walkindata.name,walkindata.title,walkindata.role,walkindata.openings,walkindata.state,walkindata.city,walkindata.qualification,walkindata.course,walkindata.specialization,walkindata.description,walkindata.skills,walkindata.date,walkindata.atype,walkindata.country,users.clogo from walkindata INNER JOIN users ON walkindata.name=users.cname where walkindata.id=". $_GET['id'];
	...
	?>  
                                 ...
                                 <div class="col-lg-12">
                                    <div class="post-title jobpost-title">
                                       <a class="text-primary"style="padding:5px 0px; font-size:20px;"><?php echo $row1['title'] ;?></a><small style="color:#ffcd01; margin-left:12px;">(<?php echo $row['atype'] ;?>)</small>
			 ...
			 <div class="post-logo">
                                       <img src="<?php echo 'uploads/' .$row1['clogo']; ?>" alt="Company-logo">
                                    </div>
			</div>
                                 <div class="col-lg-10">
                                    <div class="row" style="text-align:left">
                                       <div class="col-lg-6">
                                             ...
                                             <span style="color:#fff">Company Name:  </span><a style="color:#ffcd01" ><?php echo $row1['name'] ;?></a>
                                        
                                       </div>
                                       <div class="col-lg-6 ">
                                          <div class="post-des ">
                                             <span style="color:#fff">Functional Role:  </span><span style="color:#ffcd01"><?php echo $row1['role'] ;?></span>
                                          </div>
                                       </div>
                                    </div>
									...
									<div class="row" style="text-align:left; margin-top:15px;" >
                                       <div class="col-lg-6 ">
                                          <div class="post-des mt-3">
                                             <span style="color:#fff" >Number of Openings:  </span><span style="color:#ffcd01"><?php echo $row1['openings'] ;?></span>
                                          </div>
                                       </div>
                                       <div class="col-lg-6 ">
                                        <?php 
		...
		?>
                                          <div class="post-des mt-3">
                                            ...
                                            <?php echo $row1['country'] ;?> <?php  echo $getstatedetails['statename'];?> , <?php  echo $getcitydetails['cityname']; ?>
                                             </span>
                                          </div>
                                       </div>
                                    </div><!---row--->
...
echo $element."<br/>";
									...
									<div class="row" style="text-align:left; margin-top:15px;" >
                                       <div class="col-lg-12 ">
                                          <div class="post-des mt-3">
                                             <span style="color:#fff" >Skills:  </span><span style="color:#ffcd01"><?php echo $row1['skills'] ;?></span>
                                          </div>
                                       </div>
                                 ...
                                 <div class="col-lg-12">
                                    <div class="post-title jobpost-title">
                                      <span class="tbl-apply pull-right nav-button"><a href="candidate-login.php">Apply now</a></span>
											<span  class="pull-left" style="font-size:11px; color:#fff;"><?php echo $row1['date'] ;?></span>
