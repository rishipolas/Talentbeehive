        ...
        <div class="card-body">
          <div class="table-responsive">
			...
			<script type="text/javascript">
					...
					function passData(id,email,cname) {					
					
						// AJAX code to submit form.
					
						$.ajax({
						type: "POST",
						url: "invite_institute.php",
						data: {id:id,email:email,cname:cname},
                ...
                <input type="submit" class="btn btn-info" value="Invite" onclick="passData('<?php echo $getsearchdetails['id']; ?>','<?php echo $getsearchdetails['email'];?>','<?php echo $getsearchdetails['institute_name'];?>');"> 
