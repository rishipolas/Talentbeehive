            ...
            <div class="form-row">
			  ...
			  $row2=mysqli_fetch_array($result2); ?>
                ...
                <select  id="institute_id" name="institute_id" class="form-control" required>
					<option value="<?php echo $row2['institute_name'];?>" disabled selected>SELECT</option>															
    ...
    ?>	
		...
		<?php 
              ...
              <select id="state" class="form-control" name="state" required>
               <option value="<?php echo $row3['statename'].".". $row4['cityname'];?>" disabled selected>select state</option>
			   <?php
        if($rowCount > 0){
