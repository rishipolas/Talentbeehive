...
<html lang="en">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <img src="<?php echo 'student_resume/' .$row['student_photo']; ?>" width="100px" height="100px"  class="media-photo">
                        </a>
   ...
   <!-- <a href="<?php echo $i;?>" type="button" class="btn btn-primary" name="view" data-toggle="modal" data-target="#myModal_viewprofile<?php echo $i;?>"> View Profile</a>-->
        ...
        <a href="student_profile_view.php?id=<?php echo $idd; ?>" type="button" class="btn btn-primary" name="view">View Profile</a>
    ...
    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal_delete<?php echo $i;?>" >Delete</button> 
                  ...
                  <img alt="User Pic" src="institutelogo\<?php echo $row['student_profile']; ?>" class="img-circle img-responsive" width="150px" height="150px"> </div>
            ...
            <tr>
             ...
             <tr>
                        ...
                        <td><?php 
                         ...
                         $getcourse=mysqli_query($DB, "select course  from course where c_id=".$row['appeared']);
                         $getcoursedetails = mysqli_fetch_array($getcourse);
             echo $getcoursedetails['course'];?></td>
                      </tr>
            <tr>
                        <td> Specialization</td>
                        <td><?php 
              
                         $getspecialization=mysqli_query($DB, "select specialization  from specialization where s_id=".$row['specification']);
                         $getspecializationdetails = mysqli_fetch_array($getspecialization);
             echo $getspecializationdetails['specialization'];?></td>
                      </tr>
             <tr>
                        <td> Profile</td>
                        <td>
