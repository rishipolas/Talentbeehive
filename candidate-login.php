...
<body>
  ...
  <section id="hero">
      ...
      <div class="hero-container contOtrBlk row">
          ...
          <div class="container"> 
    	<div class="row mt-10">
    	    <div class="col-xs-12 col-lg-6 col-md-offset-3 mainw3-agileinfo form wow pulse animated">
        	    <div class="form-wrap">
    
    
  
                  
                    <form role="form" action="candidate-login.php" method="post" id="login-form" autocomplete="off">
                       <?php include('errors.php');?>

                      <div>
                      <h2 style="color:#fff">CANDIDATE  &nbsp; LOGIN</h2>
                      </div>
                        <div class="form-group">
                           <label> Enter Your Email<span class="req">*</span> </label>
                            <input type="email" name="email"  id="email"  placeholder="somebody@example.com" required>
                        </div>
                        <div class="form-group">
                            <label>Enter Your Password<span class="req">*</span> </label>
                            <input type="password" name="pass" id="key"  placeholder="Password" required>
                        </div>
                        <p class="forgot"><a href="forgetcandidate.php" >Forgot Password?</a></p> 		
                    ...
                    <div class="register-login">
                                       New User? <span><a href="fresher-register.php"> Register Now</a></span>
                                    </div>
        	    </div>
    		</div> <!-- /.col-xs-12 -->
    	</div> <!-- /.row -->
