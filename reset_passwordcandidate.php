<?php
	if(isset($_POST["reset-password"])) {
		...
		$sql = "UPDATE candidate SET pass = '" .$_POST["pass"]. "' ,cpass = '" .$_POST["cpass"]. "' where email='".$_POST['email']."'";
                              ...
                              <div class="mainw3-agileinfo form">
								...
								<?php } ?>
                                    ...
                                    <div class="field-wrap">
                                     ...
                                     <div class="field-wrap">
                                       <input type="password"  class="clr-place" name="pass" id="pass" placeholder="*New Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                                    </div>
									
									  <div class="field-wrap">
                                       <input type="password"  class="clr-place" name="cpass" id="cpass" placeholder="*Confirm New Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                                    </div>
