<?php
	if(!empty($_POST["forgot-password"])){
		...
		$sql = "Select * from candidate " . $condition;
		$result = mysqli_query($conn,$sql);
		$user = mysqli_fetch_array($result);
		
		if(!empty($user)) {
			require_once("forgot-password-recovery-mailcandidate.php");
		} else {
        	    ...
        	    <div class="form-wrap">
                     ...
                     <?php if(!empty($success_message)) { ?>
                        ...
                        <div class="form-group">
                           ...
                           <input type="user"  class="clr-place" name="name" id="name" placeholder="Candidate Name">
                        </div>
