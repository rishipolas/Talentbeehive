...
$q="select walkindata.name,walkindata.title,walkindata.role,walkindata.walk1,walkindata.venue,walkindata.time1,walkindata.openings,walkindata.state,walkindata.city,walkindata.qualification,walkindata.course,walkindata.specialization,walkindata.description,walkindata.skills,walkindata.date,walkindata.atype,walkindata.country,users.clogo from walkindata INNER JOIN users ON walkindata.name=users.cname where walkindata.id=". $_GET['id'];
