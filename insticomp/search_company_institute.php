...
$result=mysqli_query($DB,$q);
	...
	<?php $str2= $getsearchdetails['email'];?>	                            
				...
				var email=email;
					...
					/*$('.invitee').on('click',function(){
                                        alert('company invited..');
					$('.invitee').attr("disabled",true);
                                  ...
                                  <?php print $fname;?>
                                         ...
                                         <input  type="submit" class="btn btn-info pull-right invitee" name="Submit" value="Invite" onclick="passData('<?php echo $getsearchdetails['email'];?>','<?php echo $getsearchdetails['cname'];?>',<?php echo $getsearchdetails['id'];?>);$(this).css('background-color','#e80909'); $(this).val('invited');$(this).css('color','#ffff'); this.disabled=true">
                               <?php
                              /* $web="www.google.com";
                   echo ('<a  target="_blank" href="https://'.$web.'" >' . $web . '</a>');    */       
                               ?>    
