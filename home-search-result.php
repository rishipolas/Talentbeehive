...
if ($_REQUEST["role"]<>'' and $_REQUEST["title"]<>'') {
	$q = "SELECT state,city,country,atype,openings,type,qualification,title,role,skills,description,date,functionality.name as 'tname',functionality.skills  FROM functionality WHERE role >= '".mysqli_real_escape_string($con,$_REQUEST["role"])."' AND title <= '".($_REQUEST["title"])."' ".$role.$title;
}  else if ($_REQUEST["role"]<>'') {
	$q = "SELECT state,city,country,atype,openings,type,qualification,title,role,skills,description,date,functionality.name as 'tname',functionality.skills  FROM functionality WHERE role >= '".mysqli_real_escape_string($con,$_REQUEST["role"])."'".$role;
} else if ($_REQUEST["title"]<>'') {
	$q = "SELECT state,city,country,atype,openings,type,qualification,title,role,skills,description,date,functionality.name as 'tname',functionality.skills  FROM functionality WHERE title <= '".mysqli_real_escape_string($con,$_REQUEST["title"])."'".$title;
	...
	$q = "SELECT * FROM functionality where title>0 and role>0 ";
		...
		?>
                                       <div class="col-lg-6 ">
                                          <div class="post-des mt-3">
                                             <span style="color:#fff">Location:</span><span style="color:#ffcd01">
