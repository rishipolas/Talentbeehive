...
$city = $_REQUEST['city '];
		...
		//$query1 = "update users set cname='$cname',email='$email',clogo='$imagename',cinfo='$cinfo',cweb='$cweb',type='$type',person='$person',number='$number',lnumber='$lnumber' where id =" .$id;
		
		
		
		$query1 = "update users set cname='$cname',email='$email',cinfo='$cinfo',cweb='$cweb',type='$type',cloc='$cloc',person='$person',number='$number',lnumber='$lnumber',state ='$state ',city ='$city ' where id =" .$id;
  ...
  <div class="content-wrapper">
      ...
      <div class="card-body">
        <form method="POST">
		 <div class="form-group">
            ...
            <p class="form-control"><?php echo $rec['cname']; ?>
            <input class="form-control" id="exampleInputName" pattern="[a-z,A-Z]{3,50}" type="hidden" aria-describedby="emailHelp"  value=" <?php echo $rec['cname']; ?>" name="cname">
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">Email address</label> 
            <p class="form-control"><?php echo $rec['email'];?>
            <input class="form-control" id="exampleInputEmail1"pattern="[a-zA-Z0-9]+\.?[a-zA-Z0-9]+@[A-Za-z0-9.-]+\.[a-z]{2,3}" type="hidden" aria-describedby="emailHelp" value=" <?php echo $rec['email']; ?>" name="email">
          </div>
		  <div class="form-group">
            <label for="exampleInputCLogo">Company Logo</label>
           <input type="file" class="form-control-file" name="clogo" aria-describedby="fileHelp">
			<small id="fileHelp" class="form-text text-muted">*.jpeg *.jpg  *.png</small>
          </div>
           <div class="form-group">
            <label for="exampleInputCInfo">Company Info</label>
            <textarea class="form-control" id="exampleInputCInfo" pattern="[a-zA-Z0-9.@_-]{10,250}" type="textarea" value=" <?php echo $rec['cinfo']; ?>" name="cinfo"><?php echo $rec['cinfo']; ?></textarea>
          </div>
		  <div class="form-group">
            <label for="exampleInputName">Contact person Name</label>
            <input class="form-control" id="exampleInputName" pattern="[a-zA-Z\s]{7,50}"type="text" aria-describedby="emailHelp"  value=" <?php echo $rec['person']; ?>" name="person">
          </div>
		  <div class="form-group">
            <label for="exampleInputCWeb">Company Website</label>
            <input class="form-control" id="exampleInputCWeb"  type="text" value=" <?php echo $rec['cweb']; ?>" name="cweb">
          </div>
	...
	<div class="form-group">
	     ...
	     <label for="exampleInputName">Contact Number</label>
	       <div class="form-row">
	         <div class="col-md-3">	
			<input class="form-control" id="exampleInputName" type="text" name="mnumber"  value="<?php echo $mnumber ;?>">
		 </div>	
		 <div class="col-md-9">	
	     ...
	     <label for="exampleInputName">landline Number</label>
	       <div class="form-row">
				...
				<input class="form-control" id="exampleInputCWeb" type="text" pattern="[0-9]{5,8}" placeholder="Enter Landline Number" name="lnum" value=" <?php echo $lnum; ?>"required>
