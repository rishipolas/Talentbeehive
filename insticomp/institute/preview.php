	...
	<div class="form-group">
      ...
      <div class="form-group">
		...
		<?php echo $row1['hsc'];?>
           ...
           <?php 
                $id=$row1['qualification'];
                $q7="select qualification from qualification where id='".$id."'";
			  $result7=mysqli_query($DB,$q7);
			  $row7=mysqli_fetch_array($result7); ?>
           <?php 
                $id=$row1['course'];
                $q5="select course from course where c_id='".$id."'";
			  $result5=mysqli_query($DB,$q5);
			  $row5=mysqli_fetch_array($result5); ?>
			  
                <?php 
                $id=$row1['specialization'];
                $q6="select specialization from specialization where s_id='".$id."'";
		 ...
		 <label>Qualification: </label>
  	       ...
  	       <div class="col-sm-9" >
		<?php echo $row7[qualification].",". $row5['course'].",".$row6['specialization'];?>
  	       </div> 
  	     </div>
  	 </div>  
