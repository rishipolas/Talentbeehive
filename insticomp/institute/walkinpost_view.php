...
$q="select * from walkindata where name='{$_SESSION['name']}' order by id desc";
      ...
      <div class="content-wrapper">
         <div class="container-fluid">
            ...
            <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item active">walkin Posted  <strong>(<?php echo $num; ?>)</strong></li>
            </ol>
				   <?php
     if($num>0)
     {
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-10">
                                    ...
                                    <div class="row">
                                       <div class="col-lg-6 ">
                                          <div class="post-des mt-2">
                                            <strong>Date of Walkin: </strong><span><?php echo $row['walk1'];?></span>
                                          </div>
                                       </div>
									    <div class="col-lg-6 ">
                                          <div class="post-des mt-2">
                                             <strong>Time of Walkin: </strong><span><?php echo $row['time1'];?></span>
                                          </div>
                                       </div>
	...
	<hr>
					...
					<div class="row">
                                      ...
                                      <div class="col-lg-6  pull-right">
                                          ...
                                          <a type="button" class="btn btn-danger" href="walkin_del.php?status=delete&id=<?php echo $row['id'];?>" onclick="return confirm('do you want to Delete Post?');">Delete</a>
