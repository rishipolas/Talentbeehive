  ...
  <select size="5" class="form-control"  name="qualification[]" id="qualification" multiple="multiple" onclick="myFunction2()" required>
   ...
   <a class="btn btn-primary" id="show" onclick="myFunction()">Next</a> 
    ...
    ?>
     ...
     <a class="btn btn-primary" id="show12" onclick="myFunction1()">Next</a> 
      ...
      <div class="form-group qwer mnbv">
            <div class="form-row">
              <div class="col-md-12">
...
<br><a href="www.talentbeehive.com/insticomp/">Search More Job posts</a><br><br>
    ...
    swal({
     ...
     document.location.href='view_company_jobinst.php'
        ...
        {                                                 echo ("<SCRIPT>
                ...
                window.location.href='company_jobinst_reg.php';
                </SCRIPT>");
