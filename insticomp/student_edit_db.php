...
if($video!="")			
 ...
 $q2="update student_registration SET student_name='$cname',contact_number='$number',email='$email',state='$state',city='$city' where id=".$id;
if(mysqli_query($DB,$q2)==1)
{
  ...
  // header("location:company_profile.php");
	...
	else
	{
					     ...
					     window.location.href='student_profile_edit.php';
					     </SCRIPT>");
