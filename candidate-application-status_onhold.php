...
$query = "select * from candidate_job_applied where status='onhold'";		
$data = mysqli_query($DB,$query);
$num=mysqli_num_rows($data);

$query1 = "select count(*) c from candidate_job_applied where status='onhold'";		
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <div class="card-body">
          ...
          <b><u>Onhold Candidates: (<?php echo $row1['c']; ?> )</u></b> <br><br>
