    	...
    	<div class="row mt-10">
    	    <div class="col-xs-12 col-lg-6 col-md-offset-3 mainw3-agileinfo form wow pulse animated">
        	    <div class="form-wrap">
                    ...
                    <form role="form" action="company-login.php" method="post" id="login-form" autocomplete="off">
                       <?php include('errors.php');?>
                        
                         <div>
                      <h2 style="color:#fff">COMPANY  &nbsp; LOGIN</h2>
                      </div>
                        ...
                        <p class="forgot"><a href="comp_forget.php" >Forgot Password?</a></p> 
                        <button class="button button-block" name="login" />Log In</button> 
                    </form>
                    
                    <div class="register-login">
                                       New User? <span><a href="company-register.php"> Register Now</a></span>
                                    </div>
        	    </div>
    		</div> <!-- /.col-xs-12 -->
    	</div> <!-- /.row -->
