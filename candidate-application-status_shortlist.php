...
$query = "select * from candidate_job_applied where status='shortlisted'";		
$data = mysqli_query($DB,$query);
$num=mysqli_num_rows($data);

$query1 = "select count(*) c from candidate_job_applied where status='shortlisted'";		
      ...
      <ol class="breadcrumb">
        ...
        <div class="card-body">
          <div class="table-responsive" style="overflow-x:auto;">
           ...
           <b><u>Shortlisted Candidates: (<?php echo $row1['c']; ?> )</u></b> <br><br>
