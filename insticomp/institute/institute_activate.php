...
//echo $email;
$query="SELECT * from institute_registration where email='$email'";
...
if ($res == 0)
{
      ...
      {
      	//$sql = "UPDATE users SET  status = 'Approved' where email='".$email."'";
        $sql = "UPDATE institute_registration SET  status = 'Approved'";
