...
$q="select functionality.name,functionality.title,functionality.role,functionality.openings,functionality.state,functionality.city,functionality.qualification,functionality.course,functionality.specialization,functionality.description,functionality.skills,functionality.date,functionality.atype,functionality.country,users.clogo from functionality INNER JOIN users ON functionality.name=users.cname where functionality.id=". $_GET['id']; 
	...
	?>  
                                 ...
                                 <div class="col-lg-12">
                                    <div class="post-title jobpost-title">
                                       <a class="text-primary"style="padding:5px 0px; font-size:20px;"><?php echo $row['title'] ;?></a><small style="color:#ffcd01; margin-left:12px;">(<?php echo $row['atype'] ;?>)</small>
