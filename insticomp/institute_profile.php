            ...
            <div class="col-lg-9">
               <div class="row mt-4">
                  <div class="col-xl-4 col-sm-6 mb-3">
                     <div class="card">
                        <div class="card-body">
                           <div class="mr-5">Invitation</div>
                        </div>
                        <a class="card-footer text-white clearfix small z-1 bg-info" href="">
                        <span>Companies Invited<span class="badge pull-right"><?php //echo $row['maxid'];?></span></span>
                        </a>
                     </div>
                  </div>
                              ...
                              <div class='col-sm-10'>
                                 <?php
                                   ...
                                   /* echo "<div  id='editfreshemail' class='mt-2 text-primary'><i class='fa fa-envelope' style='color:black;' aria-hidden='true'></i>".$row["website_url"]."</a></div>";  */
                                    $web=$row["website_url"];
                                     echo "<div  id='editfreshemail' class='mt-2 text-primary'><i class='fa fa-envelope' style='color:black;' aria-hidden='true'></i>".'<a  target="_blank" href="https://'.$web.'" >' . $web . '</a>'."</div>";
                              ...
                              <div class="col-sm-12">
                                 ...
                                 <ul class="personal-profile mb-2">
                                    ...
                                    <?php
                                       ...
                                       echo "</li>";
                                       echo "<li>";
                                       echo "<strong class='personal-strong'>Contact Person</strong>";
